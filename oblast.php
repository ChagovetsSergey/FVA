...
<html>
	...
	<body>
		...
		<div id="content">
			<h1 align="center">Чемпионат Сумской области по футболу</h1></br>
			...
			<table class="grid" cellspacing="0">
				...
				<?php
			$sql = "SELECT * FROM obl_table order by p desc";
		...
		?>
			...
			<div id="news">
				...
				<?php
					$sql = "SELECT * FROM news WHERE category='obl' ORDER BY id DESC";
